...
function LIC4() {
  return (
    <div>
      ...
      <h2 ID="JEEVAN SHANTHI"><font color="green">JEEVAN SHANTHI</font></h2>
<p><font SIZE="4">JEEVEN SHANTHIIt is an Annuity plan which has option of purchasing Deferred annuity and can be purchased only by paying a lump sum amount. The plan provides for annuity payments of a stated amount throughout the life time of the annuitant.</font> </p>
  <br></br>
 <h4> Surrendur:</h4> <font class="h6">Payment In Case Of Surrender</font> 
   ...
   If you pay premiums for more than 3 years but less than 4, you get up to 80% of maturity sum assured.<br></br>
    ...
    If you pay premiums for more than 4 years but less than 5, you get up to 90% of maturity sum assured.<b></b>
